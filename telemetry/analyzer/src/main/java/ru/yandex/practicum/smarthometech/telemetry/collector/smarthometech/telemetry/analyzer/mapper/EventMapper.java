package ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.mapper;
...
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.domain.entity.Action;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.domain.entity.Condition;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.domain.entity.Scenario;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.domain.entity.ScenarioAction;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.domain.entity.ScenarioCondition;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.domain.entity.Sensor;
