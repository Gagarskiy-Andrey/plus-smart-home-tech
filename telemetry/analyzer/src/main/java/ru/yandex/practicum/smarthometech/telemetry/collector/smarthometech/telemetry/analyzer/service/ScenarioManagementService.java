package ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.service;
...
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.domain.entity.*;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.mapper.EventMapper;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.repository.ActionRepository;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.repository.ConditionRepository;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.repository.ScenarioRepository;
import ru.yandex.practicum.smarthometech.telemetry.collector.smarthometech.telemetry.analyzer.repository.SensorRepository;
